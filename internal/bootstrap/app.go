...
func NewApp() *App {
	...
	authMiddleware := middleware.AuthenticateAPIV1(cfg.Env, cfg.MiniProgramAppID, userRepo, authModule.SessionCache)
	router.Register(engine, authModule.Handler, userHandler, authMiddleware, statementsHandler)
